...
//strings de descrição para cada unidade
void s1(){
    char km[250];
...
double conversao(){
    if(op[0]==1 && op[1]==2){
        ...
        //preenche a segunda coluna da tabela com o valor convertido
        tabela[i][1]=y;
    }
        ...
        system("pause");
        system("cls");
        printf("Valor convertido: %.6lf\n\n", y);
        tabela[i][1]=y;
    }
    else if(op[0]==3 && op[1]==2){
        y=x*pow(10,-4);
        printf("FÓRMULA DE CONVERSÃO:\nha = m²*(10^-4)\n\n");
        printf("EXEMPLO:\n1 m² em ha\n\n");
        printf("ha = 1*(10^-4)\n");
    ...
    else if(op[0]==3 && op[1]==6){
        y=x*pow(10,12);
        printf("FÓRMULA DE CONVERSÃO:\nμm² = m²*(10^12)\n\n");
        printf("EXEMPLO:\n1 m² em μm²\n\n");
        printf("μm² = 1*(10^12)\n");
        printf("μm² = 1000000000000\n\n");
        system("pause");
        system("cls");
        printf("Valor convertido: %.2lf\n\n", y);
        tabela[i][1]=y;
    }
    else if(op[0]==3 && op[1]==7){
        y=x*pow(10,18);
        printf("FÓRMULA DE CONVERSÃO:\nnm² = m²*(10^18)\n\n");
        printf("EXEMPLO:\n1 m² em nm²\n\n");
        printf("nm² = 1*(10^18)\n");
        printf("nm² = 1000000000000000000\n\n");
        system("pause");
        system("cls");
        printf("Valor convertido: %.2lf\n\n", y);
        tabela[i][1]=y;
    }
    else if(op[0]==4 && op[1]==1){
        y=x*pow(10,-10);
        printf("FÓRMULA DE CONVERSÃO:\nkm² = cm²*(10^-10)\n\n");
        printf("EXEMPLO:\n1 cm² em km²\n\n");
        printf("km² = 1*(10^-10)\n");
        printf("km² = 0,0000000001\n\n");
        system("pause");
        system("cls");
        printf("Valor convertido: %.10lf\n\n", y);
        tabela[i][1]=y;
    }
    else if(op[0]==4 && op[1]==2){
        y=x*pow(10,-8);
        printf("FÓRMULA DE CONVERSÃO:\nha = cm²*(10^-8)\n\n");
        printf("EXEMPLO:\n1 cm² em ha\n\n");
        printf("ha = 1*(10^-8)\n");
        printf("ha = 0,00000001\n\n");
        system("pause");
        system("cls");
        printf("Valor convertido: %.8lf\n\n", y);
        tabela[i][1]=y;
    }
    else if(op[0]==4 && op[1]==3){
        y=x*pow(10,-4);
        printf("FÓRMULA DE CONVERSÃO:\nm² = cm²*(10^-4)\n\n");
        printf("EXEMPLO:\n1 cm² em m²\n\n");
        printf("m² = 1*(10^-4)\n");
    ...
    else if(op[0]==4 && op[1]==7){
        y=x*pow(10,14);
        printf("FÓRMULA DE CONVERSÃO:\nnm² = cm²*(10^14)\n\n");
        printf("EXEMPLO:\n1 cm² em nm²\n\n");
        printf("nm² = 1*(10^14)\n");
        printf("nm² = 100000000000000\n\n");
        system("pause");
        system("cls");
        printf("Valor convertido: %.2lf\n\n", y);
        tabela[i][1]=y;
    }
    else if(op[0]==5 && op[1]==1){
        y=x*pow(10,-12);
        printf("FÓRMULA DE CONVERSÃO:\nkm² = mm²*(10^-12)\n\n");
        printf("EXEMPLO:\n1 mm² em km²\n\n");
        printf("km² = 1*(10^-12)\n");
        printf("km² = 0,000000000001\n\n");
        system("pause");
        system("cls");
        printf("Valor convertido: %.12lf\n\n", y);
        tabela[i][1]=y;
    }
    else if(op[0]==5 && op[1]==2){
        y=x*pow(10,-10);
        printf("FÓRMULA DE CONVERSÃO:\nha = mm²*(10^-10)\n\n");
        printf("EXEMPLO:\n1 mm² em ha\n\n");
        printf("ha = 1*(10^-10)\n");
        printf("ha = 0,0000000001\n\n");
        system("pause");
        system("cls");
        printf("Valor convertido: %.10lf\n\n", y);
        tabela[i][1]=y;
    }
    else if(op[0]==5 && op[1]==3){
        y=x*pow(10,-6);
        printf("FÓRMULA DE CONVERSÃO:\nm² = mm²*(10^-6)\n\n");
        printf("EXEMPLO:\n1 mm² em m²\n\n");
        printf("m² = 1*(10^-6)\n");
    ...
    else if(op[0]==5 && op[1]==7){
        y=x*pow(10,12);
        printf("FÓRMULA DE CONVERSÃO:\nnm² = mm²*(10^12)\n\n");
        printf("EXEMPLO:\n1 mm² em nm²\n\n");
        printf("nm² = 1*(10^12)\n");
        printf("nm² = 1000000000000\n\n");
        system("pause");
        system("cls");
        printf("Valor convertido: %.2lf\n\n", y);
        tabela[i][1]=y;
    }
    else if(op[0]==6 && op[1]==1){
        y=x*pow(10,-18);
        printf("FÓRMULA DE CONVERSÃO:\nkm² = μm²*(10^-18)\n\n");
        printf("EXEMPLO:\n1 μm² em km²\n\n");
        printf("km² = 1*(10^-18)\n");
        printf("km² = 0,000000000000000001\n\n");
        system("pause");
        system("cls");
        printf("Valor convertido: %.18lf\n\n", y);
        tabela[i][1]=y;
    }
    else if(op[0]==6 && op[1]==2){
        y=x*pow(10,-16);
        printf("FÓRMULA DE CONVERSÃO:\nha = μm²*(10^-16)\n\n");
        printf("EXEMPLO:\n1 μm² em ha\n\n");
        printf("ha = 1*(10^-16)\n");
        printf("ha = 0,0000000000000001\n\n");
        system("pause");
        system("cls");
        printf("Valor convertido: %.16lf\n\n", y);
        tabela[i][1]=y;
    }
    else if(op[0]==6 && op[1]==3){
        y=x*pow(10,-12);
        printf("FÓRMULA DE CONVERSÃO:\nm² = μm²*(10^-12)\n\n");
        printf("EXEMPLO:\n1 μm² em m²\n\n");
        printf("m² = 1*(10^-12)\n");
        printf("m² = 0,000000000001\n\n");
        system("pause");
        system("cls");
        printf("Valor convertido: %.12lf\n\n", y);
        tabela[i][1]=y;
    }
    else if(op[0]==6 && op[1]==4){
        y=x*pow(10,-8);
        printf("FÓRMULA DE CONVERSÃO:\ncm² = μm²*(10^-8)\n\n");
        printf("EXEMPLO:\n1 μm² em cm²\n\n");
        printf("cm² = 1*(10^-8)\n");
        printf("cm² = 0,00000001\n\n");
        system("pause");
        system("cls");
        printf("Valor convertido: %.8lf\n\n", y);
        tabela[i][1]=y;
    }
    else if(op[0]==6 && op[1]==5){
        y=x*pow(10,-6);
        printf("FÓRMULA DE CONVERSÃO:\nmm² = μm²*(10^-6)\n\n");
        printf("EXEMPLO:\n1 μm² em mm²\n\n");
        printf("mm² = 1*(10^-6)\n");
    ...
    else if(op[0]==7 && op[1]==1){
        y=x*pow(10,-24);
        printf("FÓRMULA DE CONVERSÃO:\nkm² = nm²*(10^-24)\n\n");
        printf("EXEMPLO:\n1 nm² em km²\n\n");
        printf("km² = 1*(10^-24)\n");
        printf("km² = 0,000000000000000000000001\n\n");
        system("pause");
        system("cls");
        printf("Valor convertido: %.24lf\n\n", y);
        tabela[i][1]=y;
    }
    else if(op[0]==7 && op[1]==2){
        y=x*pow(10,-22);
        printf("FÓRMULA DE CONVERSÃO:\nha = nm²*(10^-22)\n\n");
        printf("EXEMPLO:\n1 nm² em ha\n\n");
        printf("ha = 1*(10^-22)\n");
        printf("ha = 0,0000000000000000000001\n\n");
        system("pause");
        system("cls");
        printf("Valor convertido: %.22lf\n\n", y);
        tabela[i][1]=y;
    }
    else if(op[0]==7 && op[1]==3){
        y=x*pow(10,-18);
        printf("FÓRMULA DE CONVERSÃO:\nm² = nm²*(10^-18)\n\n");
        printf("EXEMPLO:\n1 nm² em m²\n\n");
        printf("m² = 1*(10^-18)\n");
        printf("m² = 0,000000000000000001\n\n");
        system("pause");
        system("cls");
        printf("Valor convertido: %.18lf\n\n", y);
        tabela[i][1]=y;
    }
    else if(op[0]==7 && op[1]==4){
        y=x*pow(10,-14);
        printf("FÓRMULA DE CONVERSÃO:\ncm² = nm²*(10^-14)\n\n");
        printf("EXEMPLO:\n1 nm² em cm²\n\n");
        printf("cm² = 1*(10^-14)\n");
        printf("cm² = 0,00000000000001\n\n");
        system("pause");
        system("cls");
        printf("Valor convertido: %.14lf\n\n", y);
        tabela[i][1]=y;
    }
    else if(op[0]==7 && op[1]==5){
        y=x*pow(10,-12);
        printf("FÓRMULA DE CONVERSÃO:\nmm² = nm²*(10^-12)\n\n");
        printf("EXEMPLO:\n1 nm² em mm²\n\n");
        printf("mm² = 1*(10^-12)\n");
        printf("mm² = 0,000000000001\n\n");
        system("pause");
        system("cls");
        printf("Valor convertido: %.12lf\n\n", y);
        tabela[i][1]=y;
    }
    else if(op[0]==7 && op[1]==6){
        y=x*pow(10,-6);
        printf("FÓRMULA DE CONVERSÃO:\nμm² = nm²*(10^-6)\n\n");
        printf("EXEMPLO:\n1 nm² em μm²\n\n");
        printf("μm² = 1*(10^-6)\n");
...
void main(){
    ...
    int dec, c;
    //estrutura de repetição pro usuário decidir quando finalizar
    do{
        menu();
        if(start==1){
        ...
        if(op[1]==1)
            ...
            s7();
        printf("\n");
        //preenche a primeira coluna da tabela
        tabela[i][0]=x;
        conversao();
        system("pause");
        system("cls");
        ...
        system("pause");
        if(dec==0)
            //soma +1 em i para aumentar o número de linhas da tabela se o usuário decidir continuar
            i++;
        system("cls");
    }while(dec==0);
    //tabela final
